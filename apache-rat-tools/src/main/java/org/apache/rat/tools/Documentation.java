...
public final class Documentation {
    ...
    private static final Option LICENSES = Option.builder().longOpt("--licenses").desc("Display license information").build();
    private static final Options OPTIONS = new Options().addOption(LICENSES);
